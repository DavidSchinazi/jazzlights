...
if __name__ == "__main__":
    local_addr = '10.41.41.84'
    server = SlimDNSServer(local_addr)
    print(bytes_to_dotted_ip(server.resolve_mdns_address("jazzlights-clouds.local")))
