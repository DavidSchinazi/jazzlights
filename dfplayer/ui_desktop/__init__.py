...
class PlayerApp(Frame):
    ...
    def __init__(self, root, player):
        ...
        self.root.bind('2', lambda e: player.play_effect('slowblink'))
        self.root.bind('3', lambda e: player.play_effect('radiaterainbow'))
        self.root.bind('4', lambda e: player.play_effect('threesine'))
        self.root.bind('5', lambda e: player.play_effect('plasma'))
        self.root.bind('6', lambda e: player.play_effect('rider'))
        self.root.bind('7', lambda e: player.play_effect('flame'))
        self.root.bind('8', lambda e: player.play_effect('glitter'))
        self.root.bind('9', lambda e: player.play_effect('slantbars'))
