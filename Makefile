...
ARDUINO_BOARD:=${if ${ARDUINO_BOARD},${ARDUINO_BOARD},"esp8266:esp8266:nodemcuv2:FlashSize=4M3M,CpuFrequency=80"}
...
demo: ${CMAKE_BUILD_DIR}
	...
	LD_LIBRARY_PATH=${BUILD_DIR}/lib ${BUILD_DIR}/bin/unisparks-demo
