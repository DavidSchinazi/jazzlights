#ifndef JL_UI_UI_M5STICK_C_H
#define JL_UI_UI_M5STICK_C_H
...
class M5StickCUi : public Esp32Ui, public GpioButton::ButtonInterface {
 public:
  explicit M5StickCUi(Player& player);
  // From Esp32Ui.
