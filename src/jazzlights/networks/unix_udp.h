#ifndef JL_NETWORK_UDPSOCKET_H
#define JL_NETWORK_UDPSOCKET_H
...
class UnixUdpNetwork : public UdpNetwork {
 public:
  UnixUdpNetwork(int p = DEFAULT_UDP_PORT, const char* addr = DEFAULT_MULTICAST_ADDR);
