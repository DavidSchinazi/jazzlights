...
// static
void Esp32WiFiNetwork::WiFiDhcpTimerCallback(TimerHandle_t /*timer*/) { get()->WiFiDhcpTimerCallbackInner(); }

void Esp32WiFiNetwork::WiFiDhcpTimerCallbackInner() {
...
std::string Esp32WiFiNetwork::getStatusStr(Milliseconds currentTime) const {
...
void Esp32WiFiNetwork::reconnectToWiFi(Milliseconds currentTime, bool force) {
...
void Esp32WiFiNetwork::TaskFunctionInner() {
  const Milliseconds currentTime = timeMillis();
...
// static
void Esp32WiFiNetwork::TaskFunction(void* /*parameters*/) { get()->TaskFunctionInner(); }

Esp32WiFiNetwork::Esp32WiFiNetwork() {
  BaseType_t ret = xTaskCreatePinnedToCore(Esp32WiFiNetwork::TaskFunction, "Esp32WiFi", /*stack_size=*/4096,
                                           /*parameters=*/nullptr,
